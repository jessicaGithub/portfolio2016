...
<img src="<?php echo Site::url(); ?>/public/assets/img/welcome/chalkboard.png" alt="" id="chalk_bg"/><div id="chalkboard">
...
</div><div class="container-wide section" id="about" data-anchor="da-about">
...
</div><div class="container-wide section fp-auto-height" id="gallery" data-anchor="da-gallery">
...
</div><div class="container-wide section" id="contact" data-anchor="da-contact">
<?php
/*
require '/libraries/PHPMailer/PHPMailer.php';$mail = new PHPMailer;//$mail->SMTPDebug = 3;                               // Enable verbose debug output$mail->isSMTP();                                      // Set mailer to use SMTP
