...
/////////////////////////////////
    ...
    if ((browserName=="Microsoft Internet Explorer" || browserName=="Firefox" || browserName=="Opera" || browserName=="Safari" || browserName=="Chrome" ) && settings.mobile == 0)
    {
       ...
       // console.log($(this));
        ...
        epiElement.find("#epicaptcha_captchaO").attr("style", "height:32px; width:" +settings.width + "px; position:absolute; top:"+ tp +"; left:"+ lf+"; Background:url('public/assets/js/vendor/EpiCaptcha/img/TRANSPARENT.png') repeat; z-index:99;");
