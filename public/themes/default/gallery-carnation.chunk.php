...
S490.1,236.19,490.1,280.649z"/>
        ...
        <div class="overlay_content">
            ...
            <a class="popup" data-toggle="modal" data-target="#galleryModal">
                ...
                <div class="popup_content">
                    <p class="hero_url"><?php echo Site::url(); ?>/public/assets/img/gallery/carnation/carnation-popup.jpg</p>
    ...
    <img src="<?php echo Site::url(); ?>/public/assets/img/gallery/carnation/carnation.jpg">
</div>