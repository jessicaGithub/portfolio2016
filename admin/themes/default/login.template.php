...
<html lang="en">
    <head>
        ...
        <?php Stylesheet::add('admin/assets/css/bootstrap-lightbox.css', 'backend', 2); ?>
        ...
        <script src="<?php echo Site::url(); ?>/admin/assets/js/messenger-theme-flat.js"></script>
        <?php Javascript::add('admin/assets/js/bootstrap-lightbox.js', 'backend', 3); ?>
    ...
    <body class="login-body">
        ...
        <div class="container form-signin">
            ...
            <div class="text-center"><a class="brand" href="<?php echo Option::get('siteurl'); ?>/admin"><img src="<?php echo Option::get('siteurl'); ?>/admin/assets/img/monstra-logo-256px.png" alt="monstra" /></a></div>
