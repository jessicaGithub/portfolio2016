...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="<?php echo Site::url(); ?>/admin/assets/css/bootstrap.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo Site::url(); ?>/admin/assets/css/messenger.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo Site::url(); ?>/admin/assets/css/messenger-theme-flat.css" type="text/css" />
    <?php Stylesheet::add('admin/assets/css/chocolat.css', 'backend', 2); ?>
    <?php Stylesheet::add('admin/assets/css/bootstrap-fileupload.css', 'backend', 3); ?>
    <?php Stylesheet::add('admin/assets/css/icheck-blue.css', 'backend', 4); ?>
    <?php Stylesheet::add('admin/themes/default/css/default.css', 'backend', 5); ?>
    <?php Stylesheet::load(); ?>

    <!-- JavaScripts -->
    <script src="<?php echo Site::url(); ?>/admin/assets/js/jquery.min.js"></script>
    <script src="<?php echo Site::url(); ?>/admin/assets/js/bootstrap.min.js"></script>
    <script src="<?php echo Site::url(); ?>/admin/assets/js/messenger.min.js"></script>
    <script src="<?php echo Site::url(); ?>/admin/assets/js/icheck.min.js"></script>
    <?php Javascript::add('admin/assets/js/jquery.chocolat.js', 'backend', 3); ?>
    <?php Javascript::add('admin/assets/js/bootstrap-fileupload.js', 'backend', 4); ?>
    ...
    <script>
        $(document).ready(function() {
          ...
          $('.chocolat').Chocolat({
              overlayColor          : '#000',
              leftImg               : "<?php echo Option::get('siteurl'); ?>/admin/assets/img/chocolat/left.gif",
              rightImg              : "<?php echo Option::get('siteurl'); ?>/admin/assets/img/chocolat/right.gif",
              closeImg              : "<?php echo Option::get('siteurl'); ?>/admin/assets/img/chocolat/close.gif",
              loadingImg            : "<?php echo Option::get('siteurl'); ?>/admin/assets/img/chocolat/loading.gif"
          });
